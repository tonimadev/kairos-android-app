        ...
        fun handleIntent(intent: EventIntent) {
            ...
            viewModelScope.launch {
                when (intent) {
                    ...
                    OpenImportCalendarScreen -> appNavigator.navigateTo(CalendarNavKey.ImportCalendar)
                    CloseImportCalendarScreen -> appNavigator.popBackStack()
                    OpenManageCalendarsScreen -> appNavigator.navigateTo(CalendarNavKey.ManageCalendars)
                    CloseManageCalendarsScreen -> appNavigator.popBackStack()
